...
2. Move the downloaded zip to the folder where you want to store these course materials.
...
[zipfile-course-materials](https://raw.githubusercontent.com/UtrechtUniversity/workshop-introduction-to-python/main/introduction.python.zip)
